# Generated from program/SimpleLang.g4 by ANTLR 4.13.1
from antlr4 import *
if "." in __name__:
...
class SimpleLangListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SimpleLangParser#Modulo.
    def enterModulo(self, ctx:SimpleLangParser.ModuloContext):
        pass

    # Exit a parse tree produced by SimpleLangParser#Modulo.
